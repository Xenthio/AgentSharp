...
/// <summary>
/// Oobabooga text-generation-webui backend (OpenAI-compatible API).
/// Auto-detects chat-completions vs text-completions on first use.
/// Default base URL: http://127.0.0.1:5000
/// </summary>
public sealed class OobaboogaBackend : IBackendProvider
{
    ...
    public OobaboogaBackend(string baseUrl = "http://127.0.0.1:5000")
    {
